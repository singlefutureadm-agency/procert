<form method="POST"  id="form-cliente" action="http://localhost/procert/public/administrador/adicionar" enctype="multipart/form-data">
    <div class="container my-5">
      <div class="row">
        <!-- Coluna para imagem -->
        <div class="col-md-4 text-center mb-4">
          <img src="http://localhost/procert/public/uploads/sem-foto-servico.png" alt="kioficina Logo" class="img-fluid" id="preview-img" style="width: 100%; cursor: pointer; border-radius: 12px;">
