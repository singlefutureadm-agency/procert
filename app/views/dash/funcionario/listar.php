    ...
    <tbody>
        <?php foreach ($listaServico as $linha): ?>
            ...
            <tr>
                ...
                <td>
                    <a href="http://localhost/kioficina/public/servicos/listar/<?php echo $linha['id_servico'] ?>" title="Editar">
                        <img src="http://localhost/kioficina/public/uploads/pencil.png" alt="Editar" style="width: 20px; height: auto;">
                    </a>
                </td>
                <td>
                    <a href="http://localhost/kioficina/public/servicos/desativar/<?php echo $linha['id_servico'] ?>" title="Desativar" onclick="return confirm('Tem certeza que deseja desativar este serviço?');">
